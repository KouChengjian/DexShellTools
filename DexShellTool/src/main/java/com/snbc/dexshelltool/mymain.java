...
public class mymain {
    ...
    public static void main(String[] args) {
        ...
        try {
            File payloadSrcFile = new File(System.getProperty("user.dir")+"/DexShellTool/force/ForceApkObj.apk");   //需要加壳的程序
            System.out.println("apk size:"+payloadSrcFile.length());
            File unShellDexFile = new File(System.getProperty("user.dir")+"/DexShellTool/force/ForceApkObj.dex");	//解客dex
            ...
            String str = System.getProperty("user.dir")+"/DexShellTool/force/classes.dex";
